...
- 一般的なWeb制作環境とは利用できる編集機能や専用コードが異なる
- 端末や表示条件によって編集機能やレンダリングが異なる場合がある
- 実際の背景、色、コントラスト、折り返しを確認する必要がある
...
| LDS-04 | [`04_LDS_Lodestone_Authoring_Reference.md`](04_LDS_Lodestone_Authoring_Reference.md) | Lodestoneの技術仕様、記法、制約、Evidence |
...
- 技術仕様と設計ルールの採否判断
- 文書Statusの変更
- Case Studyや検証結果を基幹文書または管理対象成果物へ反映するかの承認
- 公開範囲と変更履歴の管理
...
Case Studyの作成とLDS文書体系への還元は記事編集の必須工程ではなく、
必要に応じてGovernanceの変更手続きに従って行う。
